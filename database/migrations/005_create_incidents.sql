...
-- The lifecycle: REPORTED -> VERIFIED -> ASSIGNED -> RESPONDING -> RESOLVED,
-- or REJECTED after review. The allowed moves are enforced by the backend
-- (backend/src/modules/incidents/lifecycle.ts).
